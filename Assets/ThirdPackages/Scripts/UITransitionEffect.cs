...
namespace Coffee.UIExtensions
{
    ...
    public class UITransitionEffect : UIEffectBase
    {
        ...
        private readonly EffectArea m_EffectArea = EffectArea.RectTransform;
        ...
        private readonly EffectMode m_EffectMode = EffectMode.Cutoff;
        ...
        protected override void SetDirty()
        {
            ...
            if (m_PassRayOnHidden) targetGraphic.raycastTarget = 0 < m_EffectFactor;
        }
